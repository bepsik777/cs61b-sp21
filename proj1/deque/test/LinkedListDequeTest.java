...
public class LinkedListDequeTest {
    ...
    @Test
    public void randomizedRemoveAndAddTest() {
    ...
    public void removeLastTest() {
        ...
        deq.addLast(2);
        assertEquals("first item should be 2", 2, (int) deq.get(0));
    }

    @Test
    public void getRecursiveRandomizedTest() {
        LinkedListDeque<Integer> myDeque = new LinkedListDeque<>();
        ...
        for (int i = 0; i < 10000; i++) {
            int random = StdRandom.uniform(0, 10000);
            assertEquals(list.get(random), myDeque.getRecursive(random));
        }
    }
}
